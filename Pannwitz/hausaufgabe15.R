...
# 2014-06-06
# Dieses Werk darf zu Übungszwecken verwendet werden.
...
body <- read.table("C:/Users/Aron.P/Documents/Statistik-f-r-Sprachwissenschaftler/Pannwitz/body_dim_long.tab",header=TRUE) 
...
# Wie sieht es aus mit den Daten der Kursteilnehmer? Plotten Sie und berechnen
